# Cyber Security Competency (CSeC) Framework Project
...
Skills and competencies are described in this [Markdown file](https://github.com/cyber-security-competency-framework/competencies/blob/main/app/src/COMPETENCIES.md) and we have a [GitHub issue to track suggestions](https://github.com/cyber-security-competency-framework/competencies/issues/2).

If you think competencies are missing, need clarification, or could be reorganised within the framework, please [create a PR] (https://github.com/cyber-security-competencies-framework) or add your feedback to the [GitHub issue to track suggestions](https://github.com/cyber-security-competency-framework/competencies/issues/2).
